...
// Send to selected lead IDs - REMOVED authenticate and authorizeAdmin
router.post(
  '/send-campaign',
  [
...
// Send to arbitrary email list (no lead record required) - REMOVED authenticate and authorizeAdmin
router.post(
  '/send-manual',
  [
...
// ── POST /email/preview ───────────────────────────────────────────────────────
// REMOVED authenticate and authorizeAdmin
